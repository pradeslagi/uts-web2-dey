...
$sql = "SELECT nm.*, m.nama_lengkap, mk.nama_mata_kuliah 
        FROM nilai_mahasiswa nm
        JOIN mahasiswa m ON nm.id_mahasiswa = m.id_mahasiswa
        JOIN mata_kuliah mk ON nm.id_mata_kuliah = mk.id_mata_kuliah";
...
<head>
    ...
    <style>
        body {
            ...
            background-color: #eef2f3; /* Warna latar belakang yang lebih lembut */
            padding: 20px;
        }
        .container {
